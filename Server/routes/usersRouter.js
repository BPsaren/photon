...
import  {validateUserRegister,sendMailVerificationValidate,passwordvalidateValidator,loginUserValidation, updateProfileValidator,otpSendMailVerificationValidate,otpVerificationValidate }from '../helpers/validation.js';
...
router.post('/send-mail-verification', sendMailVerificationValidate,userRegister.sendMmailVerification );
router.post('/forgot-password', passwordvalidateValidator,userRegister.forgotPassword );
...
router.post('/update-Profile',auth,updateProfileValidator,userRegister.updateProfile);
...
router.post('/otp-verify',otpVerificationValidate,userRegister.optVerification);
